...
@Component
public class TopicConsumerMessageMapper implements RowMapper<SourceConsumerMessage> {
    ...
    public SourceConsumerMessage mapRow(ResultSet resultSet, int i) throws SQLException {
        ...
        sourceConsumerMessage.setSource(daoFactory.getTopicDAO().getEntityById(resultSet.getInt(4)));
